...
/**
 * Description: Default Index template to display loop of blog posts, mainly used for the news page
 */
?>
<?php get_header(); ?>
<?php
...
if ($query->have_posts()) : ?>
    <main>
        <div class="v-hero hero has-max-width mb-xxl">
            ...
            <?php endif; ?>
            <div class="hero__box <?php echo $has_hero_image ? '' : 'hero__no_image' ?> is-highlighted">
                <h1 class="hero__headline"><?= get_queried_object()->post_title; ?></h1>
                <h3 class="hero__subheadline">News aus dem Verband</h3>
            </div>
        </div>
        <div class="section">
