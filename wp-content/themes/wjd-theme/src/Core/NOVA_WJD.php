...
use WJD\Utility\NOVA_Breadcrumb;
 ...
 */
 ...
 class NOVA_WJD extends WJD {

    // public function __construct()
    // {
    //     add_action( 'wp_loaded', [$this => 'remove_parent_theme_setup'] );

    //     add_action('after_setup_theme', array($this, 'themeSetup'));
    // }

    public function remove_parent_theme_setup()
    {
        remove_action( 'init', [$this => 'themeSetup']);
    }
    ...
    public function themeSetup()
    {
         ...
         * Utility
         */
        $breadcrumb = new NOVA_Breadcrumb();
    }
